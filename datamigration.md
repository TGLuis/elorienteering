...
````sql
INSERT INTO elo_source (ext_runner_id, source_type, runner_id, fullname_in_source)
SELECT elo_runner.HELGA_ID, 1, elo_runner.id, elo_runner.fullname FROM elo_runner WHERE helga_id is not null;
