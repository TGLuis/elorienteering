...
urlpatterns = [
    ...
    path("course/<int:course_pk>/", views.course, name="course"),
    path("future/<int:course_pk>/", views.future, name="future"),
    path("courses/", views.courses, name="courses"),
    path("restless/", views.restless, name="restless"),
    path("about", views.about, name="about"),
    path("runner/<int:runner_id>/", views.detail, name="runner"),
